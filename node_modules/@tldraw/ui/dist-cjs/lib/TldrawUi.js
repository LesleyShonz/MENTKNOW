...
const TldrawUiContent = import_react.default.memo(function TldrawUI({
  ...
  const isFocusMode = (0, import_signia_react.useValue)("focus", () => editor.instanceState.isFocusMode, [editor]);
  const isDebugMode = (0, import_signia_react.useValue)("debug", () => editor.instanceState.isDebugMode, [editor]);
