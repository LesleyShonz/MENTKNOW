...
var import_TextHelpers = require("../shapes/text/TextHelpers");
...
class TextManager {
  ...
  getTextElement() {
    ...
    elm.id = `__textMeasure_${(0, import_data.uniqueId)()}`;
  ...
  measureText = (textToMeasure, opts) => {
    ...
    elm.textContent = import_TextHelpers.TextHelpers.normalizeTextForDom(textToMeasure);
