...
import { EventsProvider } from "./hooks/useEventsProvider.mjs";
...
function TldrawUiContextProvider({
  ...
  return /* @__PURE__ */ jsx(AssetUrlsProvider, { assetUrls: useDefaultUiAssetUrlsWithOverrides(assetUrls), children: /* @__PURE__ */ jsx(TranslationProvider, { overrides: useMergedTranslationOverrides(overrides), children: /* @__PURE__ */ jsx(EventsProvider, { onEvent: onUiEvent, children: /* @__PURE__ */ jsx(ToastsProvider, { children: /* @__PURE__ */ jsx(DialogsProvider, { children: /* @__PURE__ */ jsx(BreakPointProvider, { children: /* @__PURE__ */ jsx(InternalProviders, { overrides, children }) }) }) }) }) }) });
}
