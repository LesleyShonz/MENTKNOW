...
var import_hard_reset = require("../utils/hard-reset");
var import_refresh_page = require("../utils/refresh-page");
...
const DefaultErrorFallback = ({ error, editor }) => {
  ...
  const isDarkModeFromApp = (0, import_signia_react.useValue)(
    "isDarkMode",
    () => {
      try {
        if (editor) {
  ...
  const refresh = () => {
    (0, import_refresh_page.refreshPage)();
  };
  const resetLocalState = async () => {
    (0, import_hard_reset.hardResetEditor)();
  };
