...
var import_getBrowserCanvasMaxSize = require("./getBrowserCanvasMaxSize");
...
async function getSvgAsImage(svg, options) {
  ...
  const blob = await new Promise(
    (resolve) => canvas.toBlob(
      (blob2) => {
        if (!blob2 || import_debug_flags.debugFlags.throwToBlob.value) {
          resolve(null);
        }
        resolve(blob2);
      },
  ...
  return (0, import_png.setPhysChunk)(view, effectiveScale, {
    type: "image/" + type
  });
}
