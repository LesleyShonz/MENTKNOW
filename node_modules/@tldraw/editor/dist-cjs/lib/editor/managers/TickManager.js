...
class TickManager {
  ...
  prevPoint = new import_primitives.Vec2d();
  updatePointerVelocity = (elapsed) => {
    ...
    if (elapsed === 0)
      return;
    const delta = import_primitives.Vec2d.Sub(currentScreenPoint, prevPoint);
    this.prevPoint = currentScreenPoint.clone();
    const length = delta.len();
    const direction = length ? delta.div(length) : new import_primitives.Vec2d(0, 0);
