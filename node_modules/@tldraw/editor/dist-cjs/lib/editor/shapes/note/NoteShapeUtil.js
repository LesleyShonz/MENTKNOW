...
const NOTE_SIZE = 200;
class NoteShapeUtil extends import_ShapeUtil.ShapeUtil {
  static type = "note";
  canEdit = () => true;
  ...
  getBounds(shape) {
    ...
    return new import_primitives.Box2d(0, 0, NOTE_SIZE, height);
  }
  getOutline(shape) {
    return this.bounds(shape).corners;
  }
  getCenter(_shape) {
    return new import_primitives.Vec2d(NOTE_SIZE / 2, this.getHeight(_shape) / 2);
  }
  component(shape) {
    const {
      id,
  ...
  indicator(shape) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      {
        rx: "7",
        width: (0, import_primitives.toDomPrecision)(NOTE_SIZE),
        height: (0, import_primitives.toDomPrecision)(this.getHeight(shape))
      }
    );
  }
