...
const StylePanel = function StylePanel2({ isMobile }) {
  ...
  const relevantStyles = (0, import_signia_react.useValue)("getRelevantStyles", () => getRelevantStyles(editor), [editor]);
...
function CommonStylePickerSet({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "tlui-style-panel__section__common", "aria-label": "style panel styles", children: [
