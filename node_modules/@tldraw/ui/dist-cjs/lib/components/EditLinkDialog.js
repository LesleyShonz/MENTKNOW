...
const EditLinkDialog = (0, import_signia_react.track)(function EditLinkDialog2({ onClose }) {
...
const EditLinkDialogInner = (0, import_signia_react.track)(function EditLinkDialogInner2({
  onClose,
  selectedShape
}) {
  const editor = (0, import_editor.useEditor)();
