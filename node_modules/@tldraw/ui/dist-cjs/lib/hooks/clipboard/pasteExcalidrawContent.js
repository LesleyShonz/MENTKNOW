...
async function pasteExcalidrawContent(editor, clipboard, point) {
  ...
  const rootShapes = (0, import_utils.compact)(rootShapeIds.map((id) => editor.getShapeById(id)));
  const bounds = import_primitives.Box2d.Common(rootShapes.map((s) => editor.getPageBounds(s)));
...
function getBend(element, startPoint, endPoint) {
  ...
  if (element.points.length > 2) {
    ...
    bend = import_primitives.Vec2d.Dist(point, med);
