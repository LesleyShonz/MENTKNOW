...
const EvenInnererIndicator = ({ shape, util }) => {
  return (0, import_signia_react.useStateTracking)("Indicator:" + shape.type, () => util.indicator(shape));
};
const InnerIndicator = ({ editor, id }) => {
  const shape = (0, import_signia_react.useValue)("shape", () => new ShapeWithPropsEquality(editor.store.get(id)), [
    editor,
    id
  ]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    {
      fallback: ShapeIndicatorErrorFallback ? (error) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShapeIndicatorErrorFallback, { error }) : null,
...
const _ShapeIndicator = ({ id, className, color, opacity }) => {
  ...
  const transform = (0, import_signia_react.useValue)(
    "transform",
    () => {
