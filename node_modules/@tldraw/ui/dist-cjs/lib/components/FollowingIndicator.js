...
function FollowingIndicator() {
  ...
  const followingUserId = (0, import_signia_react.useValue)("follow", () => editor.instanceState.followingUserId, [editor]);
  if (!followingUserId)
    return null;
...
function FollowingIndicatorInner({ userId }) {
  ...
  if (!presence)
    return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "tlui-following", style: { borderColor: presence.color } });
}
