...
__export(constants_exports, {
  ...
  HASH_PATERN_ZOOM_NAMES: () => HASH_PATERN_ZOOM_NAMES,
  INTERNAL_POINTER_IDS: () => INTERNAL_POINTER_IDS,
  MAJOR_NUDGE_FACTOR: () => MAJOR_NUDGE_FACTOR,
  MAX_ASSET_HEIGHT: () => MAX_ASSET_HEIGHT,
  MAX_ASSET_WIDTH: () => MAX_ASSET_WIDTH,
  MAX_PAGES: () => MAX_PAGES,
...
const MAX_ASSET_WIDTH = 1e3;
const MAX_ASSET_HEIGHT = 1e3;
...
const DEFAULT_ANIMATION_OPTIONS = {
  duration: 0,
  easing: import_primitives.EASINGS.easeInOutCubic
};
const HAND_TOOL_FRICTION = 0.09;
const GRID_STEPS = [
...
const COLLABORATOR_TIMEOUT = 3e3;
