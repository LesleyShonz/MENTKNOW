...
const PageMenu = function PageMenu2() {
  ...
  const pages = (0, import_signia_react.useValue)("pages", () => editor.pages, [editor]);
  const currentPage = (0, import_signia_react.useValue)("currentPage", () => editor.currentPage, [editor]);
  const isReadonlyMode = (0, import_signia_react.useValue)("isReadonlyMode", () => editor.isReadOnly, [editor]);
  const maxPageCountReached = (0, import_signia_react.useValue)(
    "maxPageCountReached",
    () => editor.pages.length >= import_editor.MAX_PAGES,
    [editor]
  );
  const isCoarsePointer = (0, import_signia_react.useValue)("isCoarsePointer", () => editor.isCoarsePointer, [editor]);
