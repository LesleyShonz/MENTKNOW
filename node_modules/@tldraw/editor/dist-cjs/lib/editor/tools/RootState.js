...
var import_SelectTool = require("./SelectTool/SelectTool");
var import_StateNode = require("./StateNode");
var import_ZoomTool = require("./ZoomTool/ZoomTool");
class RootState extends import_StateNode.StateNode {
  static id = "root";
  static initial = "select";
  static children = () => [import_SelectTool.SelectTool, import_ZoomTool.ZoomTool];
  onKeyDown = (info) => {
    switch (info.code) {
      case "KeyZ": {
