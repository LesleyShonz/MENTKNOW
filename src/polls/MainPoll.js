        ...
        <div>
            {isContainerVisible && (
                <div className='createButton-container'>
                    ...
                    <button className='create-new-poll-button' type='button' onClick={handleCreateClick}>
                        Create new Poll
                    </button>
                    <button className='vote-on-existing-poll' type='button' onClick={handleVoteClick}>
