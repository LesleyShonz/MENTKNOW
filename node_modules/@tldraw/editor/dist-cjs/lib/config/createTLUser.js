...
function createTLUser(opts = {}) {
  return {
    derivePresenceState: opts.derivePresenceState ?? (() => (0, import_signia.computed)("presence", () => null)),
    userPreferences: opts.userPreferences ?? (0, import_signia.computed)("userPreferences", () => (0, import_TLUserPreferences.getUserPreferences)()),
