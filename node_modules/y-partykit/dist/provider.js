...
var time = __toESM(require("lib0/time"));
...
var authProtocol = __toESM(require("y-protocols/auth"));
...
var url = __toESM(require("lib0/url"));
var messageSync = 0;
...
var WebsocketProvider = class extends import_observable.Observable {
  maxBackoffTime;
  bcChannel;
  url;
  roomname;
