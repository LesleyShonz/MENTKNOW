...
if (typeof Element !== "undefined") {
  ...
  (0, import_signia.react)("element removal logging", () => {
...
function createDebugValueBase(def) {
  ...
  const valueAtom = (0, import_signia.atom)(`debug:${def.name}`, storedValue ?? defaultValue);
  if (typeof window !== "undefined") {
    if (def.shouldStoreForSession) {
      (0, import_signia.react)(`debug:${def.name}`, () => {
