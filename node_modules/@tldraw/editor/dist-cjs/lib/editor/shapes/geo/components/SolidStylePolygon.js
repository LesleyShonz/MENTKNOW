...
const SolidStylePolygon = React.memo(function SolidStylePolygon2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ShapeFill.ShapeFill, { d: path, fill, color }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: path, stroke: `var(--palette-${color}`, strokeWidth, fill: "none" })
  ] });
});
