...
class EmbedShapeUtil extends import_BaseBoxShapeUtil.BaseBoxShapeUtil {
  static type = "embed";
  ...
  component(shape) {
    ...
    const isEditing = (0, import_useIsEditing.useIsEditing)(shape.id);
    const embedInfo = (0, import_react.useMemo)(() => (0, import_embeds.getEmbedInfoUnsafely)(url), [url]);
    const isHoveringWhileEditingSameShape = (0, import_signia_react.useValue)(
      "is hovering",
      () => {
    ...
    if (embedInfo?.definition.type === "github_gist") {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_HTMLContainer.HTMLContainer, { className: "tl-embed-container", id: shape.id, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        Gist,
        {
          id: idFromGistUrl,
          width: (0, import_primitives.toDomPrecision)(w),
          height: (0, import_primitives.toDomPrecision)(h),
          isInteractive,
          pageRotation
        }
      ) });
    ...
    const sandbox = getSandboxPermissions({
      ...import_tlschema.embedShapePermissionDefaults,
      ...embedInfo?.definition.overridePermissions ?? {}
    });
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_HTMLContainer.HTMLContainer, { className: "tl-embed-container", id: shape.id, children: embedInfo?.definition ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "iframe",
      {
        ...
        style: {
          ...
          boxShadow: (0, import_dom.getRotatedBoxShadow)(pageRotation),
  ...
  indicator(shape) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "rect",
      {
        width: (0, import_primitives.toDomPrecision)(shape.props.w),
        height: (0, import_primitives.toDomPrecision)(shape.props.h),
