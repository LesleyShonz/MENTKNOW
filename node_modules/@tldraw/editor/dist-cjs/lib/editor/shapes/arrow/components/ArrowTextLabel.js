...
var import_TextHelpers = require("../../text/TextHelpers");
const ArrowTextLabel = React.memo(function ArrowTextLabel2({
  ...
  const { rInput, isEditing, handleFocus, handleBlur, handleKeyDown, handleChange, isEmpty } = (0, import_useEditableText.useEditableText)(id, "arrow", text);
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "tl-arrow-label__inner", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "textarea",
          {
            ...
            onBlur: handleBlur,
            onContextMenu: import_dom.stopEventPropagation
          }
        )
      ] })
    }
