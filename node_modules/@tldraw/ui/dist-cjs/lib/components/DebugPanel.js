...
const ShapeCount = function ShapeCount2() {
  const editor = (0, import_editor.useEditor)();
  const count = (0, import_signia_react.useValue)("rendering shapes count", () => editor.renderingShapes.length, [editor]);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    count,
    " Shapes"
  ] });
};
const DebugMenuContent = (0, import_signia_react.track)(function DebugMenuContent2({
  renderDebugMenuItems
}) {
  const editor = (0, import_editor.useEditor)();
...
const DebugFlagToggle = (0, import_signia_react.track)(function DebugFlagToggle2({
  flag,
  onChange
}) {
