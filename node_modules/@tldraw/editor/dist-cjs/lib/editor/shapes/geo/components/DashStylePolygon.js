...
const DashStylePolygon = React.memo(function DashStylePolygon2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ShapeFill.ShapeFill, { d: innerPath, fill, color }),
    lines && lines.map((l, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "path",
      {
      ...
      "g",
      {
        ...
        children: [
          Array.from(Array(outline.length)).map((_, i) => {
            ...
            const dist = import_primitives.Vec2d.Dist(A, B);
