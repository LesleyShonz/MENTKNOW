...
var import_DefaultSpinner = require("../../../components/DefaultSpinner");
var import_HTMLContainer = require("../../../components/HTMLContainer");
var import_useIsCropping = require("../../../hooks/useIsCropping");
...
class ImageShapeUtil extends import_BaseBoxShapeUtil.BaseBoxShapeUtil {
  static type = "image";
  ...
  component(shape) {
    ...
    const isCropping = (0, import_useIsCropping.useIsCropping)(shape.id);
    const prefersReducedMotion = (0, import_dom.usePrefersReducedMotion)();
    ...
    const isSelected = (0, import_signia_react.useValue)(
      "onlySelectedShape",
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_HTMLContainer.HTMLContainer, { id: shape.id, style: { overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "tl-image-container", style: containerStyle, children: [
        ...
        ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("g", { transform: `translate(${(w - 38) / 2}, ${(h - 38) / 2})`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_DefaultSpinner.DefaultSpinner, {}) }),
  ...
  indicator(shape) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { width: (0, import_primitives.toDomPrecision)(shape.props.w), height: (0, import_primitives.toDomPrecision)(shape.props.h) });
  }
  async toSvg(shape) {
    ...
    if (containerStyle && crop) {
      ...
      const points = [
        new import_primitives.Vec2d(crop.topLeft.x * width, crop.topLeft.y * height),
        new import_primitives.Vec2d(crop.bottomRight.x * width, crop.topLeft.y * height),
        new import_primitives.Vec2d(crop.bottomRight.x * width, crop.bottomRight.y * height),
        new import_primitives.Vec2d(crop.topLeft.x * width, crop.bottomRight.y * height)
      ];
  ...
  onDoubleClickEdge = (shape) => {
    ...
    const crop = (0, import_utils.deepCopy)(props.crop) || {
      topLeft: { x: 0, y: 0 },
      bottomRight: { x: 1, y: 1 }
    };
    const w = 1 / (crop.bottomRight.x - crop.topLeft.x) * shape.props.w;
    const h = 1 / (crop.bottomRight.y - crop.topLeft.y) * shape.props.h;
    const pointDelta = new import_primitives.Vec2d(crop.topLeft.x * w, crop.topLeft.y * h).rot(shape.rotation);
    const partial = {
      id: shape.id,
      type: shape.type,
