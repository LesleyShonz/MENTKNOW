...
const Toolbar = function Toolbar2() {
  ...
  const activeToolId = (0, import_signia_react.useValue)("current tool id", () => editor.currentToolId, [editor]);
  const isHandTool = activeToolId === "hand";
  const geoState = (0, import_signia_react.useValue)("geo", () => editor.sharedStyles.getAsKnownValue(import_editor.GeoShapeGeoStyle), [
    editor
  ]);
