...
function precise(A) {
  return `${(0, import_primitives.toDomPrecision)(A.x)},${(0, import_primitives.toDomPrecision)(A.y)} `;
}
function average(A, B) {
  return `${(0, import_primitives.toDomPrecision)((A.x + B.x) / 2)},${(0, import_primitives.toDomPrecision)((A.y + B.y) / 2)} `;
}
