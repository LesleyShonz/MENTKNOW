...
class HistoryManager {
  ...
  constructor(ctx, onBatchComplete, annotateError) {
    this.ctx = ctx;
    this.onBatchComplete = onBatchComplete;
    this.annotateError = annotateError;
  }
  _undos = (0, import_signia.atom)("HistoryManager.undos", (0, import_Stack.stack)());
  // Updated by each action that includes and undo
  _redos = (0, import_signia.atom)("HistoryManager.redos", (0, import_Stack.stack)());
  ...
  ignoringUpdates = (fn) => {
    ...
    try {
      ;
      ({ undos, redos } = (0, import_signia.transact)(() => fn(undos, redos)));
    } finally {
  ...
  mark = (id = (0, import_data.uniqueId)(), onUndo = true, onRedo = true) => {
