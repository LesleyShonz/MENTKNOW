...
const DefaultCollaboratorHint = ({
  ...
  (0, import_useTransform.useTransform)(
    rSvg,
    (0, import_primitives.clamp)(point.x, viewport.minX + 5 / zoom, viewport.maxX - 5 / zoom),
    (0, import_primitives.clamp)(point.y, viewport.minY + 5 / zoom, viewport.maxY - 5 / zoom),
    1 / zoom,
    import_primitives.Vec2d.Angle(viewport.center, point)
  );
