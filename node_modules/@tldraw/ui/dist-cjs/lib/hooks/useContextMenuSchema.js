...
const TLUiContextMenuSchemaProvider = (0, import_signia_react.track)(function TLUiContextMenuSchemaProvider2({
  overrides,
  children
}) {
  ...
  const atLeastOneShapeOnPage = (0, import_signia_react.useValue)(
    "atLeastOneShapeOnPage",
    () => editor.currentPageShapeIds.size > 0,
    []
  );
  const isTransparentBg = (0, import_signia_react.useValue)(
    "isTransparentBg",
