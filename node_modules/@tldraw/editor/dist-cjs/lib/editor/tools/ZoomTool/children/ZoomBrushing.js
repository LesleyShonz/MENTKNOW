...
class ZoomBrushing extends import_StateNode.StateNode {
  static id = "zoom_brushing";
  info = {};
  zoomBrush = new import_primitives.Box2d();
  onEnter = (info) => {
    this.info = info;
    this.update();
  };
  ...
  update() {
    ...
    this.zoomBrush.setTo(import_primitives.Box2d.FromPoints([originPagePoint, currentPagePoint]));
