...
function useGestureEvents(ref) {
  ...
  const events = React.useMemo(() => {
    ...
    const onWheel = ({ event }) => {
      ...
      const delta = (0, import_shared.normalizeWheel)(event);
    ...
    const initOrigin = new import_primitives.Vec2d();
    const prevOrigin = new import_primitives.Vec2d();
    ...
    const updatePinchState = (0, import_lodash.default)((type) => {
      if (pinchState === null) {
        ...
        const originDistance = import_primitives.Vec2d.Dist(initOrigin, prevOrigin);
