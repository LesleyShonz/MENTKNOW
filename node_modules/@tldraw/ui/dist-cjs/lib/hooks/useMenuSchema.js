...
function TLUiMenuSchemaProvider({ overrides, children }) {
  ...
  const animationSpeed = (0, import_signia_react.useValue)("animationSpeed", () => editor.animationSpeed, [editor]);
  const isGridMode = (0, import_signia_react.useValue)("isGridMode", () => editor.isGridMode, [editor]);
  const isSnapMode = (0, import_signia_react.useValue)("isSnapMode", () => editor.isSnapMode, [editor]);
  const isToolLock = (0, import_signia_react.useValue)("isToolLock", () => editor.instanceState.isToolLocked, [editor]);
  const isFocusMode = (0, import_signia_react.useValue)("isFocusMode", () => editor.instanceState.isFocusMode, [editor]);
  const isDebugMode = (0, import_signia_react.useValue)("isDebugMode", () => editor.instanceState.isDebugMode, [editor]);
  const exportBackground = (0, import_signia_react.useValue)(
    "exportBackground",
    () => editor.instanceState.exportBackground,
    [editor]
  );
  const emptyPage = (0, import_signia_react.useValue)("emptyPage", () => editor.currentPageShapeIds.size === 0, [editor]);
  const selectedCount = (0, import_signia_react.useValue)("selectedCount", () => editor.selectedIds.length, [editor]);
  ...
  const isZoomedTo100 = (0, import_signia_react.useValue)("isZoomedTo100", () => editor.zoomLevel === 1, [editor]);
  const menuSchema = (0, import_react.useMemo)(() => {
    const menuSchema2 = (0, import_utils.compact)([
